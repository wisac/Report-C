...
<html lang="en">
    <head>
        ...
        <title>REPORTC Admin Assign Subjects< </title>
                    ...
                    <div class="main-page">
                     ...
                     <div class="container-fluid">
                            <div class="row page-title-div">
                                <div class="col-md-6">
                                    <h2 class="title">Assign Subjects</h2>
...
<option selected="true" disabled value="">Select Class</option>
...
<option selected="true" disabled value="">Select Subject</option>
