...
<body>
  ...
  <img class="bg-img" src="images/parents_play_graound.jpg">
  <div class="title-container" style="z-index: 5; position: absolute; right: 0; left: 0">
    ...
    <div class="school-box" style="display: inline">
  ...
  <div class="main-wrapper">
    ...
    <div class="login-bg-color bg-black-300">
      <div style="height: 100vh; width: 100vw; background-color: rgba(0,0,0,0.70); position: absolute; z-index: 0">
          ...
          <div class="panel login-box" style="opacity: 100">
            <div class="panel-heading">
              <div class="panel-title text-center">
                ...
                <h4>Check your kid's results here</h4>
              </div>
            </div>
            <div class="panel-body p-20">
              ...
              <form action="result.php" method="post">
                <div class="form-group">
                  <label for="rollid">Enter your kids Student ID</label>
                  <input type="text" class="form-control" id="rollid" placeholder="Enter Your Kids Student ID"
