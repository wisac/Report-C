                                                    ...
                                                    <table class="table table-hover table-bordered">
                                                        ...
                                                        <tbody>
                                                            ...
                                                            if ($countrow = $query->rowCount() > 0) {
                                                                ...
                                                                <tr>
                                                                    ...
                                                                    <td><b>
                                                                            ...
                                                                            if ($totlcount >= '80')
                                                                                echo htmlentities("A");
                                                                            else if ($totlcount >= '70')
                                                                                echo htmlentities("B");
                                                                                else if ($totlcount >= '60')
                                                                                echo htmlentities("C");
                                                                                else if ($totlcount >= '50')
                                                                                echo htmlentities("D");
                                                                                else if ($totlcount >= '40')
                                                                                echo htmlentities("E");
                                                                            else
                                                                                echo htmlentities("F");
                                                            ...
                                                            <div class="alert alert-danger left-icon-alert" role="alert">
                                                                <strong>Sorry, Your ID was not found in the selected class. Please enter the correct ID and select the correct class!</strong>
                                                                <?php
                                                                echo htmlentities("");
                                                }
                                                ?>
