...
<body>
  ...
  <img class="bg-img" src="images/students_kids_class.jpg">
  ...
  <div class="main-wrapper">
    ...
    <div class="login-bg-color bg-black-300">
      <div style="height: 100vh; width: 100vw; background-color: rgba(0,0,0,0.60); position: absolute; z-index: 0">
            ...
            <div class="panel-body p-20">
              ...
              <form action="result.php" method="post">
                <div class="form-group">
                  ...
                  <input type="text" class="form-control" id="rollid" placeholder="Enter Your Student ID"
